...
5. Update [AGENTS.md](../../../../AGENTS.md), [CLAUDE.md](../../../../CLAUDE.md), [specs/PRODUCTION_FLOW.md](../features/runtime-topology/evidence/production-flow.md) references.
...
|---|---|---|---|
| **A — Chrome Extension** (production) | [internal/server/agent/crawl.go](../../../../internal/server/agent/crawlingest/crawl.go), [local-connector-extension/](../../../../local-connector-extension/) | `cmd/scraper/crawl_runtime.go:submitConnectorCrawl` routes here when a connector is online | Live, used today |
...
- Document in [PRODUCTION_FLOW.md](../features/runtime-topology/evidence/production-flow.md) the fallback role, when it activates, and the known single-batch limitation.
- Effort: 1–2 hours.
...
8. Update [AGENTS.md](../../../../AGENTS.md), [CLAUDE.md](../../../../CLAUDE.md), [PRODUCTION_FLOW.md](../features/runtime-topology/evidence/production-flow.md) — drop "worker fallback" mentions.
