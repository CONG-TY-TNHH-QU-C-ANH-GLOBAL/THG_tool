var THGShared = globalThis.THGShared || (() => {
  ...
  const CONTENT_FILES = [
    ...
    'content/facebook/commenting/comment_constants.js',
    'content/facebook/commenting/comment_composer_guard.js',
    'content/execution_dedup.js',
    'content/facebook/commenting/comment_submit.js',
    'content/facebook/commenting/comment_state_machine.js',
    'content/facebook/commenting/comment_composer.js',
    'content/facebook/commenting/comment_button.js',
    ...
    'content/reverify.js',
    'content/facebook/commenting/comment_executor.js',
    'content/bridge.js',
    'content.js'
  ];
  const CAPABILITIES = {
