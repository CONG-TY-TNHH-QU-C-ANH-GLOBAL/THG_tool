...
_SYSTEM_PROMPT = (
    ...
    "   - 'tìm khách / khách hàng / buyer / customer / có nhu cầu mua' → potential_customer\n"
    "   - 'tìm ứng viên / tuyển dụng / hiring / candidate' → candidate\n"
    "   - 'tìm đối tác / supplier / nhà cung cấp / reseller' → partner\n"
    "   - empty when ambiguous.\n"
    "2. include_signals: short phrases (≤80 chars) that REAL targets typically write. "
    "Cover both Vietnamese (with diacritics) and English variants.\n"
    "3. exclude_signals: short phrases that off-target authors write. "
    "If target_role=potential_customer, ALWAYS include common provider/agency phrases "
    "such as 'chuyên cung cấp', 'nhận order số lượng lớn', 'agency cần tuyển', "
    "'inbox báo giá', 'DM giá', 'we provide', 'our service'.\n"
