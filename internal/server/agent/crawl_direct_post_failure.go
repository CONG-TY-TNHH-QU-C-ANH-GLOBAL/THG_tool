...
// directPostFailureUserMessage and directPostFailureCodeFromExtensionError moved to
// crawl_direct_post_outcome.go (pure outcome classification, same package).
