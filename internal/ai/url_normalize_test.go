...
// Case 1 (PR-6): the stored website normalizes to the canonical
// clickable URL — all three agreed input shapes.
func TestCanonicalWebsite_NormalizesToClickable(t *testing.T) {
	cases := map[string]string{
		"www.thgfulfill.com/vi":         "https://www.thgfulfill.com/vi",
		"https://www.thgfulfill.com/vi": "https://www.thgfulfill.com/vi",
		"http://www.thgfulfill.com/vi":  "https://www.thgfulfill.com/vi",
		"thgfulfill.com/vi":             "https://thgfulfill.com/vi",
...
func TestRepairWebsiteMentions_SpacedAndVariants(t *testing.T) {
	canonical := "https://www.thgfulfill.com/vi"
	cases := []struct {
		in   string
		want string
	}{
		{"Xem thêm tại thgfulfill. com/vi nhé", "Xem thêm tại https://www.thgfulfill.com/vi nhé"},
		{"Xem thêm tại thgfulfill com nhé", "Xem thêm tại https://www.thgfulfill.com/vi nhé"},
		{"Website: http://thgfulfill.com/vi", "Website: https://www.thgfulfill.com/vi"},
		{"Website: thgfulfill.com/vi", "Website: https://www.thgfulfill.com/vi"},
		{"Đã có https://www.thgfulfill.com/vi rồi", "Đã có https://www.thgfulfill.com/vi rồi"}, // canonical untouched
