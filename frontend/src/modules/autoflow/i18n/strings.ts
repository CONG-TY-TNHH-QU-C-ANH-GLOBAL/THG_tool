...
export const STRINGS: Record<Lang, DashboardStrings> = {
  vi: {
    ...
    views: {
      ...
      browserSub: 'Phiên Chrome thật của org, observable từ dashboard.',
      postingTitle: 'Posting',
      postingSub: 'Hàng chờ post lên group/profile, có guardrail.',
      commentingTitle: 'Commenting',
      commentingSub: 'Watch list + composer, comment đúng tone sales.',
      leaderboardTitle: 'Leaderboard',
      leaderboardSub: 'KPI sales từ dữ liệu thật, không mock.',
      dataPrivateTitle: 'Data Private',
      dataPrivateSub: 'Knowledge hub: file, sources, business memory.',
      settingsTitle: 'Settings',
      settingsSub: 'Workspace, thành viên, phân quyền, automation policy.',
    },
  },
  en: {
    nav: {
