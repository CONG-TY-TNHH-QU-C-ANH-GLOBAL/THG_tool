...
func main() {
	...
	srv := server.New(db, jobStore, agent, workspaceMgr, server.Config{
		...
		RenderProvider:              cfg.RenderProvider,
		ReelWebhookSecret:           cfg.ReelWebhookSecret,
		CloudflareAPIToken:          cfg.CloudflareAPIToken,
		CloudflareAccountID:         cfg.CloudflareAccountID,
		ReelFakeAutocomplete:        cfg.ReelFakeAutocomplete,
		AnthropicAPIKey:             cfg.AnthropicAPIKey,
		AnthropicScriptModel:        cfg.AnthropicScriptModel,
		ReelMarketingGuidePath:      cfg.ReelMarketingGuidePath,
		FALKey:                      cfg.FALKey,
		FALVideoModel:               cfg.FALVideoModel,
		HeyGenKey:                   cfg.HeyGenKey,
		HeyGenAvatarID:              cfg.HeyGenAvatarID,
		HeyGenVoiceID:               cfg.HeyGenVoiceID,
		FPTTTSKey:                   cfg.FPTTTSKey,
		FPTVoice:                    cfg.FPTVoice,
		ReelMediaDir:                cfg.ReelMediaDir,
		FFmpegPath:                  cfg.FFmpegPath,
		ReelLogoPath:                cfg.ReelLogoPath,
