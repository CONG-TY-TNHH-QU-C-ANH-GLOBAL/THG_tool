...
// This file holds the DOMAIN-aware helpers for the composition root:
// prompt parsing, org business-context assembly, keyword extraction, and
// URL→platform/source classification. The generic typeless-arg coercion
// (argString/argInt64/argBool) lives in action_args.go.
